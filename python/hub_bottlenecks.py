...
def main():
	degree_outliers = pd.read_csv('node_info/degree_upper_outliers_10percent.csv')
	betweenness_outliers = pd.read_csv('node_info/betweenness_upper_outliers_10percent.csv')
